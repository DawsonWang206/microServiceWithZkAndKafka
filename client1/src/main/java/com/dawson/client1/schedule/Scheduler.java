...
public class Scheduler {
    ...
    @Autowired
    private KafkaTemplate<String, R> rKafkaTemplate;
    ...
    public void  helloScheduler() throws Exception{
        ...
        ListenableFuture<SendResult<String, String>> a = stringKafkaTemplate.send(ClientConstant.TEST_KAFKA_TOPIC, helloFrClient1ByFeign);
    ...
    public R feinDoEntity() throws Exception {
        ...
        ListenableFuture<SendResult<String, R>> a = rKafkaTemplate
